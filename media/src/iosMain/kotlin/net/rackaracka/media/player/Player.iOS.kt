...
import net.rackaracka.media.player.extensions.toAVPlayerItem
import net.rackaracka.media.player.extensions.toAVPlayerItems
import net.rackaracka.media.player.extensions.toDuration
import net.rackaracka.media.toAVLayerVideoGravity
...
class PlayerIOS : Player {
    ...
    override fun play() {
        when (currentPlayingItem?.status) {
            ...
            AVPlayerItemStatusFailed -> println("Failed to play") // Det går inte att relodda samma låt, skapa nytt track, är den död är den död
